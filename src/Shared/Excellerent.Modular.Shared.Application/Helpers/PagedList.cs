namespace Excellerent.Modular.Shared.Application.Helpers
{
    public class PagedList<T> : List<T>
    {
        ...
        public static PagedList<T> ToPagedList(System.Collections.Generic.IEnumerable<T> src, int pageIndex, int pageSize)
        {
