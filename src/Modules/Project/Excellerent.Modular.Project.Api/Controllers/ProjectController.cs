...
using Excellerent.Modular.Project.Core.Commands.Delete_Project;
using Excellerent.Modular.Project.Core.Commands.Update_Project;
using Excellerent.Modular.Project.Core.Queries.GetProjectById;
using Excellerent.Modular.Project.Core.Queries.GetProjects;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace Excellerent.Modular.Project.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
