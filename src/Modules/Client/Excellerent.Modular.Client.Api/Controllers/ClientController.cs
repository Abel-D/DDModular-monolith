...
using Excellerent.Modular.Client.Core.Commands.DeleteClient;
using Excellerent.Modular.Client.Core.Commands.UpdateClient;
using Excellerent.Modular.Client.Core.Queries.GetClientById;
using Excellerent.Modular.Client.Core.Queries.GetClients;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace Excellerent.Modular.Client.Api.Controllers
{
    [ApiController]
    [Route("[controller]")]
